...
var btn = document.getElementsByClassName("met1");
var prov = document.getElementById("prov");
var city = document.getElementById("city");
var country = document.getElementById("country");
var address=document.getElementById("ANewAddress");
...
function showAddr() {
    ...
    a.innerHTML +="<div readonly='readonly'><input type='text'  value='"+value+"' id='"+value+"' style='border:solid;width:250px'/></div>"
    msgbox(0);
}
