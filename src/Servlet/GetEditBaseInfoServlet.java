 ...
 */
@WebServlet("/GetEditBaseInfoServlet")
public class GetEditBaseInfoServlet  extends HttpServlet {
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetEditBaseInfoServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            restaurant=yummyService.GetEditBaseInfo();
