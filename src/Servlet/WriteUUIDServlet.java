 ...
 */
@WebServlet("/WriteUUIDServlet")
public class WriteUUIDServlet extends HttpServlet{
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public WriteUUIDServlet() {
        super();
...
//    out.println("</p>You are visitor number " + webCounter);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name,phone,address,type,chaptcha;
        ...
        try {
            result=restaurantService.WriteUUID(chaptcha,name,phone,address,type);
