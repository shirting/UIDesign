 ...
 */
@WebServlet("/ResgetOrderbyTimeServlet")
public class ResgetOrderbyTimeServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ResgetOrderbyTimeServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            orderArrayList =orderService.ResgetOrderbyTime(ResName,Chaptcha);
